...
class ConferenceController extends AbstractController
{
    ...
    public function show(Request $request, Conference $conference, 
        CommentRepository $commentRepository, string $photoDir, NotifierInterface $notifier)
    {
        $comment = new Comment();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $notifier->send(new Notification('Your comment will be posted after moderation.', ['browser']));
        ...
        if ($form->isSubmitted()) {
            $notifier->send(new Notification('Can you check your submission?', ['browser']));
        }
